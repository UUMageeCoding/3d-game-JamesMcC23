...
public class updated_player_controller : MonoBehaviour
{
    ...
    [SerializeField] private float player_height = 1f;
    ...
    private void Update()
    {
        ...
        groundedPlayer = Physics.Raycast(transform.position, Vector3.down, player_height * 0.5f + 0.3f, ground);
